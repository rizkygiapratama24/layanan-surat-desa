            ...
            <main class="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <form action="<?= site_url('surat/tambah') ?>" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="id_jenis_surat" class="form-control js-example-basic-single <?php echo form_error('id_jenis_surat') ? 'is-invalid' : ''; ?>">
                                                ...
                                                ?>
                                                    <option value="<?php echo $jenis->id_jenis_surat ?>" <?php if ($jenis->id_jenis_surat == set_value('id_jenis_surat')) echo "selected='selected'" ?>><?php echo $jenis->nama_jenis_surat ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-0">
                                            ...
                                            <input type="text" name="nama_surat" class="form-control <?php echo form_error('nama_surat') ? 'is-invalid' : ''; ?>" value="<?php echo set_value('nama_surat'); ?>" placeholder="Nama Surat" autocomplete="off">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                <label class="btn btn-info pl-4 pr-4">
                                                    <input type="radio" name="sedia_mandiri" id="Ya" value="Ya" autocomplete="off"> Ya
                                                </label>
                                                <label class="btn btn-info pl-4 pr-4 active">
                                                    <input type="radio" name="sedia_mandiri" id="Tidak" value="Tidak" autocomplete="off" checked=""> Tidak
                                                </label>
                                            </div>
                                        </div>
                                    </div>

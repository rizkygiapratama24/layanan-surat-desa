            ...
            <main class="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <form action="<?= site_url('syarat_surat/edit/' . $syarat_surat->id_syarat_surat) ?>" method="post">
                            <input type="hidden" name="id_syarat_surat" value="<?= $syarat_surat->id_syarat_surat; ?>">
                            <div class="card-body">
                                <div class="form-group mb-0">
                                    ...
                                    <input type="text" name="nama_syarat_surat" class="form-control <?php echo form_error('nama_syarat_surat') ? 'is-invalid' : ''; ?>" value="<?php echo $syarat_surat->nama_syarat_surat; ?>" placeholder="Nama Dokumen Persyaratan" autocomplete="off">
